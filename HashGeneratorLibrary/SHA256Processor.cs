...
namespace HashGeneratorLibrary
{
    ...
    /// </summary>
    public class SHA256Processor : ICryptoProcessor
    {
        /// <summary>
        ...
        /// <exception cref="ArgumentNullException">Throws when SHA256 hash or datatStream is not set.</exception>
        ...
        /// <param name="buffer">Data buffer array.</param>
        /// <returns>Return true if the stream data matches with given SHA256 checksum.</returns>
        /// <exception cref="ArgumentNullException">Throws when SHA256 hash or buffer is not set.</exception>
